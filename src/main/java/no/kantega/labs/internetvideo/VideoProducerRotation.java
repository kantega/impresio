...
public class VideoProducerRotation
{
    ...
    private void produceVideo() {
        ...
        for(int i = 0; i < 100; i++ , time += 100) {
            ...
            g.setTransform(AffineTransform.getRotateInstance(i*2*Math.PI/100, 150/2, 180/2));
            ...
            g.fillRect(0, 0, (i*150)/100, 25);

            g.setColor(Color.WHITE);
            g.drawString("Frame " + i, 20,20);
